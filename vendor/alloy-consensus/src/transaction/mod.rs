...
pub trait SignableTransaction<Signature>: Transaction {
    /// Optional alternative signature verification for custom authorization schemes.
...
mod tests {
    ...
    fn test_custom_envelope() {
        ...
        assert_eq!(
            MyTxType::try_from(2u8).unwrap(),
            MyTxType::Ethereum(TxType::Eip1559)
        );
...
/// Experimental Cosmos transaction authorization.
pub mod cosmos;
pub use cosmos::TxCosmos;
